...
namespace MessageBus.Messaging.InProcess
{
    public class InProcessMessageBroker : IMessageBroker, ICollectable, IExecutable
    {
        ...
        private void ValidatePublish<T>(in T message, IReadOnlyList<TopicName> topics)
        {
