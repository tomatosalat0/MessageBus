...
namespace MessageBus.Messaging.Tests.UnitTests
{
    ...
    public class MessageBrokerTests
    {
        ...
        public async Task MessageBrokerThrowsExceptionWhenPublishGetsNull()
        {
            ...
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(() => broker.PublishEvent<object>(null, new TopicName("Topic")));
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(() => broker.PublishEvent<object>(new object(), null));
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(() => broker.PublishCommand<object>(null, new TopicName("Topic")));
            await Assert.ThrowsExceptionAsync<ArgumentNullException>(() => broker.PublishCommand<object>(new object(), null));
        }
        ...
        {
            using IMessageBroker broker = CreateBrokerWithManualScheduler(out _);
            await Assert.ThrowsExceptionAsync<ArgumentOutOfRangeException>(() => broker.PublishEvent(new object(), Array.Empty<TopicName>()));
        }
        ...
        public async Task DisposedMessageBrokerThrowsDisposedException()
        {
            ...
            Assert.ThrowsException<ObjectDisposedException>(() => broker.Events(new TopicName("Topic")));
            Assert.ThrowsException<ObjectDisposedException>(() => broker.Commands(new TopicName("Topic")));
            await Assert.ThrowsExceptionAsync<ObjectDisposedException>(() => broker.PublishEvent(new object(), new TopicName("Topic")));
            await Assert.ThrowsExceptionAsync<ObjectDisposedException>(() => broker.PublishCommand(new object(), new TopicName("Topic")));
        }
        ...
        public async Task MessageBrokerReturnsTrueIfMessageHasArrived()
        {
            ...
            await broker.PublishCommand<object>(new object(), "Topic");
        ...
        public async Task DrainingTheMessageBrokerCallsUntilNoMessageIsLeft()
        {
            ...
            await broker.PublishCommand(new object(), new TopicName("Topic"));
            await broker.PublishCommand(new object(), new TopicName("Topic"));
