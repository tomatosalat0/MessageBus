...
namespace MessageBus.Tests.UnitTests
{
    ...
    public partial class MessageBusTests
    {
        ...
        public void EventSubscriptionThrowsExceptionForInvalidEvents()
        {
            ...
            Assert.ThrowsExceptionAsync<IncompleteConfigurationException>(async () => await bus.FireQuery<MissingTopicQuery, MessageQueryResult>(new MissingTopicQuery(), TimeSpan.FromSeconds(2)));
        }
        ...
        public void DisposedBusThrowsObjectDisposedException()
        {
            ...
            Assert.ThrowsExceptionAsync<ObjectDisposedException>(async () => await bus.FireQuery<MissingTopicQuery, MessageQueryResult>(new MissingTopicQuery(), TimeSpan.FromSeconds(2)));
        }
