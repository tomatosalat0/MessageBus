...
namespace MessageBus.Examples.CrossModulesCommunication
{
    ...
    {
        /*
        This examples shows to do cross modules communication without introducing a shared
        ...
        While it might look unnecessary in the first place, it can actually help to make each module
